...
def add_final_training_ops(FLAGS,class_count, final_tensor_name, bottleneck_tensor):
...
def main(FLAGS):
  ...
  if class_count >1:
    ...
    (train_step, cross_entropy, bottleneck_input, ground_truth_input,
     final_tensor) = add_final_training_ops(FLAGS,len(image_lists.keys()),
...
def app_run():
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/home/ubuntu/flaskapp/tf_files/flower_photos',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/home/ubuntu/flaskapp/tf_files/retrained_graph.pb',#''/tmp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/home/ubuntu/flaskapp/tf_files/retrained_labels.txt',#''/tmp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/home/ubuntu/flaskapp/tf_files/tmp/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/home/ubuntu/flaskapp/tf_files/inception',#''/tmp/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/home/ubuntu/flaskapp/tf_files/bottlenecks',#''/tmp/bottleneck',
